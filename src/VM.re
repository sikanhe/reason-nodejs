...
[@bs.obj] external createContextOptions: (
    ~name: string=?,
    ~origin: string=?,
    ~codeGeneration: {. "strings": bool, "wasm": bool }=?
  ) => createContextOptions = "";
[@bs.val] [@bs.module "vm"] external createContext: Js.t({..} as 'a) => contextifiedObject('a) = "createContext";
[@bs.val] [@bs.module "vm"] external createContextWithOptions: (Js.t({..} as 'a), createContextOptions) => contextifiedObject('a) = "createContext";
...
module Script = {
  ...
  [@bs.send] external runInNewContext: (t, string, contextifiedObject('a)) => 'b = "runInNewContext";
