...
[@bs.val] [@bs.module "util"]
external deprecate2: (('a1, 'a2) => 'result, 'a1, 'a2) => 'result = "deprecate";
[@bs.val] [@bs.module "util"]
external deprecate3: (('a1, 'a2, 'a3) => 'result, 'a1, 'a2, 'a3) => 'result = "deprecate";
[@bs.val] [@bs.module "util"]
external deprecate4: (('a1, 'a2, 'a3, 'a4) => 'result, 'a1, 'a2, 'a3, 'a4) => 'result =
  "deprecate";
[@bs.val] [@bs.module "util"]
external deprecate5: (('a1, 'a2, 'a3, 'a4, 'a5) => 'result, 'a1, 'a2, 'a3, 'a4, 'a5) => 'result =
  "deprecate";
[@bs.val] [@bs.module "util"]
external deprecate6:
  (('a1, 'a2, 'a3, 'a4, 'a5, 'a6) => 'result, 'a1, 'a2, 'a3, 'a4, 'a5, 'a6) => 'result =
  "deprecate";
...
[@bs.val] [@bs.module "util"]
external inspectWithOptions: ('a, inspectOptions) => string = "inspect";
[@bs.val] [@bs.module "util"] [@bs.scope "inspect"]
external customInspectSymbol: Js.Types.symbol = "custom";
[@bs.val] [@bs.module "util"] [@bs.scope "inspect"]
external defaultInspectOptions: inspectOptions = "defaultOptions";
[@bs.val] [@bs.module "util"] external isDeepStrictEqual: ('a, 'a) => bool = "isDeepStrictEqual";

[@bs.val] [@bs.module "util"]
external promisify0: (Js.Exn.t => unit, unit) => Js.Promise.t(unit) = "promisify";
[@bs.val] [@bs.module "util"]
external promisifyWithResult0: ((Js.Exn.t, 'res) => unit, unit) => Js.Promise.t('res) =
  "promisify";
[@bs.val] [@bs.module "util"]
external promisify1: ('a1, (Js.Exn.t, 'a1) => unit, 'a1) => Js.Promise.t(unit) = "promisify";
[@bs.val] [@bs.module "util"]
external promisifyWithResult1: ('a1, (Js.Exn.t, 'res) => unit, 'a1) => Js.Promise.t('res) =
  "promisify";
[@bs.val] [@bs.module "util"]
external promisify2: ('a1, 'a2, Js.Exn.t => unit, 'a1, 'a2) => Js.Promise.t(unit) = "promisify";
[@bs.val] [@bs.module "util"]
external promisifyWithResult2:
  ('a1, 'a2, (Js.Exn.t, 'res) => unit, 'a1, 'a2) => Js.Promise.t('res) =
  "promisify";
[@bs.val] [@bs.module "util"]
external promisify3: ('a1, 'a2, 'a3, Js.Exn.t => unit, 'a1, 'a2, 'a3) => Js.Promise.t(unit) =
  "promisify";
[@bs.val] [@bs.module "util"]
external promisifyWithResult3:
  ('a1, 'a2, 'a3, (Js.Exn.t, 'res) => unit, 'a1, 'a2, 'a3) => Js.Promise.t('res) =
  "promisify";
[@bs.val] [@bs.module "util"]
external promisify4:
  ('a1, 'a2, 'a3, 'a4, Js.Exn.t => unit, 'a1, 'a2, 'a3, 'a4) => Js.Promise.t(unit) =
  "promisify";
[@bs.val] [@bs.module "util"]
external promisifyWithResult4:
  ('a1, 'a2, 'a3, 'a4, (Js.Exn.t, 'res) => unit, 'a1, 'a2, 'a3, 'a4) => Js.Promise.t('res) =
  "promisify";
[@bs.val] [@bs.module "util"]
external promisify5:
  ('a1, 'a2, 'a3, 'a4, 'a5, Js.Exn.t => unit, 'a1, 'a2, 'a3, 'a4, 'a5) => Js.Promise.t(unit) =
  "promisify";
[@bs.val] [@bs.module "util"]
external promisifyWithResult5:
  ('a1, 'a2, 'a3, 'a4, 'a5, (Js.Exn.t, 'res) => unit, 'a1, 'a2, 'a3, 'a4, 'a5) =>
  Js.Promise.t('res) =
  "promisify";
