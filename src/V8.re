...
type heapSpaceStats = {
  ...
  [@bs.as "space_size"]
  space_size: int,
  [@bs.as "space_used_size"]
  space_used_size: int,
  [@bs.as "space_available_size"]
  space_available_size: int,
  [@bs.as "space_physical_size"]
...
type heapStats = {
  ...
  [@bs.as "total_physical_size"]
  total_physical_size: int,
  [@bs.as "total_available_size"]
  total_available_size: int,
  [@bs.as "used_heap_space"]
  used_heap_space: int,
  [@bs.as "heap_size_limit"]
  heap_size_limit: int,
  [@bs.as "malloced_memory"]
  malloced_memory: int,
  [@bs.as "peak_malloced_memory"]
  peak_malloced_memory: int,
  [@bs.as "does_zap_garbage"]
  does_zap_garbage: int,
  [@bs.as "number_of_native_contexts"]
  number_of_native_contexts: int,
  [@bs.as "number_of_detached_contexts"]
...
type heapCodeStats = {
  ...
  [@bs.as "bytecode_and_metadata_size"]
  bytecode_and_metadata_size: int,
  [@bs.as "external_script_source_size"]
