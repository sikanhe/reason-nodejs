module Interface = {
  ...
  [@bs.obj] external interfaceOptions: (
    ~input: Stream.t(Stream.readable),
    ~output: Stream.t(Stream.writable)=?,
  ...
  [@bs.send] external clearLine: (t, Stream.t(Stream.writable), int) => bool = "clearLine";
  [@bs.send] external clearScreenDown: (t, Stream.t(Stream.writable), unit => unit) => bool = "clearScreenDown";
  [@bs.send] external cursorTo: (
      t,
      Stream.t(Stream.writable),
      int,
      Js.Undefined.t(int),
      Js.Undefined.t(unit => unit)
    ) => bool = "cursorTo";
  [@bs.send] external moveCursor: (t, Stream.t(Stream.writable), int, int, Js.Undefined.t(unit => unit)) => bool = "moveCursor";
