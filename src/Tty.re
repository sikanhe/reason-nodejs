...
module WriteStream = {
  ...
  module Impl = {
    ...
    [@bs.send] external clearLineLeft: (t, [@bs.as {json|-1|json}] _, ~callback: unit => unit=?, unit) => bool = "clearLine";
    [@bs.send] external clearLineRight: (t, [@bs.as {json|1|json}] _, ~callback: unit => unit=?, unit) => bool = "clearLine";
    [@bs.send] external clearLine: (t, [@bs.as {json|0|json}] _, ~callback: unit => unit=?, unit) => bool = "clearLine";
    [@bs.send] external clearScreenDown: (t, ~callback: unit => unit=?, unit) => bool = "clearScreenDown";
    [@bs.get] external columns: t => int = "columns";
    [@bs.send] external getColorDepth: t => int = "getColorDepth";
    [@bs.send] external getColorDepthFromEnv: (t, Js.Dict.t('a)) => int = "getColorDepth";
    [@bs.send] external getWindowSize: t => (int, int) = "getWindowSize";
    [@bs.send] external hasColors: (t, int) => bool = "hasColors";
    [@bs.send] external hasColorsFromEnv: (t, int, Js.Dict.t('a)) => bool = "hasColors";
