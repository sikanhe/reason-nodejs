  ...
  module Events = {
    ...
    external onSocket:
      (
        subtype('w, 'r, 'a),
        [@bs.as "socket"] _,
        [@bs.uncurry] (Net.TcpSocket.t => unit)
      ) =>
      subtype('w, 'r, 'a) =
      "on";
    [@bs.send]
...
module Agent = {
  type t;
  [@bs.send]
  external createConnection: (t, Js.t({..})) => Net.TcpSocket.t =
    "createConnection";
  [@bs.send]
  external createConnectionWithCallback:
    (t, Js.t({..}), unit => unit) => Net.TcpSocket.t =
    "createConnection";
  [@bs.send]
  external keepSocketAlive: (t, Net.TcpSocket.t) => unit = "keepSocketAlive";
  [@bs.send]
  external reuseSocket: (t, Net.TcpSocket.t, ClientRequest.t) => unit =
    "reuseSocket";
  ...
  module Events = {
    ...
    external onClientError:
      (
        subtype('a),
        [@bs.as "clientError"] _,
        [@bs.uncurry] ((Js.Exn.t, Net.TcpSocket.t) => unit)
      ) =>
      subtype('a) =
      "on";
    [@bs.send]
